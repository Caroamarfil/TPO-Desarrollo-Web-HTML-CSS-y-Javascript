...
const cuarto='<div class="formu"><div class="contenedor-formulario">    <form id="formulario2">    <label for="nombre">Título del documento:</label>    <input size="30" type="text" name="nombre">    <label for= "tematica">Temática del documento:</label>    <select name="tematica">        <option>Biología</option>        <option>Filosofía</option>        <option>Física</option>        <option>Geografía</option>        <option>Historia</option>        <option>Química</option>        <option>Matemática</option>   <option>Otra</option>    </select>    <label for="otraTema">Temática: </label>    <input size="30" type="text" name="otraTema" placeholder="Solo si seleccionó Otra" >   <label for= "tipo">Tipo de documento:</label>  <select name="tipo">  <option>Ensayo</option>       <option>Monografía</option>       <option>Trabajo Práctico</option>        <option>Ejercicios resueltos</option>        <option>Informe</option>        <option>Otro</option>    </select>    <label for="otraTipo">Tipo:</label>    <input size="30" type="text" name="otraTipo" placeholder="Solo si seleccionó Otro" >    <label for="documento">Archivo:</label>   <input style= "background-color:white; border-radius: 0px;" type="file" name="documento">   <label for="descripcion">Descripción del contenido:</label>  <textarea name="descripcion" id="discrip" cols="40" rows="3"></textarea></fieldset><input class="botones" type="reset" value="Borrar formulario"><input  class="botones" type="submit" value="Subir Documento"></div>'
